@echo off
@echo off
title H@CK3R $2H Ioncube Priv8 Decoder V1 ::: Iran 0861 Was Here
color a
goto mainMenu
...
echo                     Cracked and Ripe And Nulled By H@CK3R $2H
echo                             Email : Hacker.S2h@Gmail.com
echo                                Iran Hacker From 0861
echo                #######################################################
...
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "IonCube v8.1 Decoder By Sanishan" "IonCube Priv8 Decoder V1 By H@CK3R $2H"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "Version  : 1,0,0,4" "Version  : 1"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "Author   : Sanishan" "Author   : H@CK3R $2H"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "Release on : 20-01-2014" "Release on : 14-Feb-2014"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "Website  : http://deioncube.me" "Email  : Hacker.S2h@Gmail.com"
)
...
FOR %%i IN (c:\ioncube_priv8_decoder_v1\DECODED\*.php) DO (
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "iDezender 8.0" "IonCube Priv8 Decoder V1 By H@CK3R $2H"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "* @ Developed by Qarizma" " "
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "Visit our website:" "Version  : 1"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "www.iRadikal.com" "Author   : H@CK3R $2H"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "For cheap decoding service :)" "Release on : 14-Feb-2014"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "And for the ionCube Decoder!" "Email  : Hacker.S2h@Gmail.com"
)
...
FOR %%i IN (c:\ioncube_priv8_decoder_v1\DECODED\*.php) DO (
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "DeionCube.me" "IonCube Priv8 Decoder V1 By H@CK3R $2H"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "NWS" "Version  : 1"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "IonCube 7 support" "Author   : H@CK3R $2H"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "by:" "Release on : 14-Feb-2014"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "DeIonCube" "Email  : Hacker.S2h@Gmail.com"
)
...
FOR %%i IN (c:\ioncube_priv8_decoder_v1\DECODED\*.php) DO (
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "Dezend for PHP5" "IonCube Priv8 Decoder V1 By H@CK3R $2H"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "        NWS      " "Author   : H@CK3R $2H"
c:\ioncube_priv8_decoder_v1\php\lib_fixer.exe %%i "Nulled.WS" "Email  : Hacker.S2h@Gmail.com"
)
